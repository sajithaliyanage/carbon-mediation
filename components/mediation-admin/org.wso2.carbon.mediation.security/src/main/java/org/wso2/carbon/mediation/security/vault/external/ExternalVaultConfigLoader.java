...
public class ExternalVaultConfigLoader {
    ...
    public static void loadExternalVaultConfigs(SecretCallbackHandlerService secretCallbackHandlerService)
        ...
        String vaultConfigFilePath = confPath + File.separator + SECURITY_DIR + File.separator + EXTERNAL_VAULTS;
        OMElement vaultConfig = null;

        try {
            String configsFileAsString = FileUtils.readFileToString(new File(vaultConfigFilePath));
